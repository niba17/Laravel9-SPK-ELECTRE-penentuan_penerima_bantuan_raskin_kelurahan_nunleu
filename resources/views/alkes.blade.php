...
@section('title', 'PUSKESMALAKA | Alkes')
@section('content')
            ...
            <div
                ...
                <nav class="mb-0" aria-label="breadcrumb">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item active"><a href="/alkes">Alkes</a></li>
        ...
        <section class="container-fluid">
            ...
            <div class="card mb-4">
                <div class="card-header justify-content-between align-items-center d-flex">
                    ...
                    <a href="/alkes-add" type="button" class="btn btn-primary-faded btn-sm">Tambah
                        Alkes <i class="fa-solid fa-plus"></i>
                    </a>
                    {{-- <div class="dropdown">
                                ...
                                @foreach ($alkes as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <span class="text-danger">
                                                    <span class="badge rounded-pill bg-danger-faded text-danger">Faskes
                                                        belum dipilih!
                                                    </span>
                                                </span>
                                            @endif
