    ...
    <main id="main">
        ...
        <section class="container-fluid">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="/faskes_alkes-store" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    <label for="alkes_id" class="form-label">Alkes</label>
                                    <select class="form-select @error('alkes_id') is-invalid @enderror" id="faskes_alkes_id"
                                        name="alkes_id">
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    <label for="faskes_id" class="form-label">Faskes</label>
                                    <select class="form-select @error('faskes_id') is-invalid @enderror" id="faskes_id"
                                        name="faskes_id">
