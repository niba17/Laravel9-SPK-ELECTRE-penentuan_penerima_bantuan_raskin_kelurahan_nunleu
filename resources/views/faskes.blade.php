...
@section('title', 'PUSKESMALAKA | Faskes')
@section('content')
    ...
    <main id="main">
            ...
            <div
                ...
                <nav class="mb-0" aria-label="breadcrumb">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item active"><a href="/faskes_alkes">Faskes</a></li>
        ...
        <section class="container-fluid">
            <div class="row">
                <div class="col-lg-6">
                    <a href="/faskes-add" type="button" class="col-lg-4 col-sm-3 btn mb-2 btn-primary-faded btn-sm">Tambah
                ...
                <div class="col-lg-6">
                    <a href="/faskes_alkes-add" type="button"
                        class="col-lg-4 col-sm-3 btn mb-2 btn-primary-faded btn-sm">Tambah
                                    ...
                                    <tbody>
                                        @foreach ($alkes as $item)
                                            ...
                                            <div class="form-group form-check-custom mb-0">
                                                ...
                                                <td>
                                                    <a href="alkes-edit/{{ $item->id }}"><i
                                                            class="fa-solid fa-pen-to-square text-primary"></i></a>
                                                    <span class="px-1 fw-bold">|</span>
                                                    <a href="#" onclick="hapus('{{ $item->id }}','alkes')"><i
                                                            class="fa-solid fa-trash text-danger"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
