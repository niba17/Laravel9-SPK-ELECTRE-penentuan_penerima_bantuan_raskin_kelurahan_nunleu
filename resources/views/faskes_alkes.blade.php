...
@section('title', 'PUSKESMALAKA | Faskes & Alkes')
@section('content')
            ...
            <div
                ...
                <nav class="mb-0" aria-label="breadcrumb">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item active"><a href="/faskes_alkes">Faskes & Alkes</a></li>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card mb-4">
                        <div class="card-header justify-content-between align-items-center d-flex">
                            <h6 class="card-title m-0">Daftar Faskes</h6>
                            <a href="/faskes-add" type="button" class="btn btn-primary-faded btn-sm">Tambah
                                Faskes <i class="fa-solid fa-plus"></i>
                            </a>
                            {{-- <div class="dropdown">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card mb-4">
                        <div class="card-header justify-content-between align-items-center d-flex">
                            ...
                            <a href="/faskes_alkes-add" type="button" class="btn btn-primary-faded btn-sm">Tambah
                                Alkes pada Faskes <i class="fa-solid fa-plus"></i>
                            </a>
                            {{-- <div class="dropdown">
                        <button class="btn btn-link dropdown-toggle dropdown-toggle-icon fw-bold p-0" type="button"
                            id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                                    ...
                                    <tbody>
                                        @foreach ($alkes as $item)
                                            ...
                                            <div class="form-group form-check-custom mb-0">
                                                ...
                                                <td>
                                                    @foreach ($item->faskes_alkes as $item3)
                                                        <a href="faskes_alkes-edit/{{ $item3->id }}"><i
                                                        ...
                                                        <a href="#"
                                                            onclick="hapus('{{ $item3->id }}','faskes_alkes')"><i
