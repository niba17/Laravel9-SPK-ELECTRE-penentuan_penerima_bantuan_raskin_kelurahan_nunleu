...
@section('content')
    ...
    <main id="main">
        ...
        <section class="container-fluid">
            {{-- <a href="/alkes" type="button" class="col-lg-2 col-sm-3 btn mb-2 btn-primary-faded btn-sm"><i
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="/alkes-update/{{ $alkes->id }}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                        id="nama" name="nama" placeholder="..." value="{{ $alkes->nama }}">
                                    @error('nama')
                        ...
                        <a href="/alkes" class="btn btn-outline-danger">Batal</a>
