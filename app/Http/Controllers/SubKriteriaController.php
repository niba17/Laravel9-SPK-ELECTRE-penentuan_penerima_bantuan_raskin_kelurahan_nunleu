...
class SubKriteriaController extends Controller
{
    ...
    public function penduduk_request()
    {
        $penduduk = Penduduk::with(['penduduk_sub_kriteria.kriteria'])->get();
        $kriteria = Kriteria::with(['penduduk_sub_kriteria.penduduk'])->get();

        return response()->json([$kriteria, $penduduk]);
    }
}